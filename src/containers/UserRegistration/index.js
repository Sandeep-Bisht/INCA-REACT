                            ...
                            <div className="row actual-form-1">
                                ...
                                <div className="col-md-12">
                                    <div className="form-wrap">
                                        <div className="input-wrap">
                                            ...
                                            <label><i className="fa-solid fa-person me-2"></i>Name</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-12">
                                    <div className="form-wrap">
                                        <div className="input-wrap">
                                            ...
                                            <label><i className="fa-solid far far fa-envelope me-2"></i>E-mail</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-12">
                                    <div className="form-wrap">
                                        <div className="input-wrap">
                                            ...
                                            <label><i className="fa-solid far fas fa-phone me-2"></i>Phone Number</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-12">
                                    <div className="btn-wrapper mt-3">
                                        <button type="submit" className=" form-submit " onClick={() => registrationSubmitRequest()} disabled={validateRegisterForm()}>Submit</button>
                                    </div>
                                </div>

                                <div className="end-wrap mt-2">
                                    <p className='common-para mb-0 mt-3'>Already have an Account? <Link to="/login" className='ms-2 common-yellow-color f2 text-decoration-none'>Login</Link></p>
                                </div>
