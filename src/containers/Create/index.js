                    ...
                    <div className="container">
                        <div className="row mt-5 mb-5">
                            <div className="col-md-4">
                                ...
                                <input type="text" onChange={(e) => userInformationOnchangeHandler(e)} className="form-control" value={userInformation.name} disabled = {isDisabled} id="name" />
                            </div>
                            <div className="col-md-4">
                                <label for="InputPosition" className="form-label">Designation/Position</label>
                                <input type="text" className="form-control" onChange={(e) => userInformationOnchangeHandler(e)} value={userInformation.designation} disabled = {isDisabled} id="designation" />
                            </div>
                            <div className="col-md-4">
                                <label for="InputAffiliation" className="form-label">Affiliation</label>
                                <input type="text" className="form-control" onChange={(e) => userInformationOnchangeHandler(e)} value={userInformation.affilation} disabled = {isDisabled} id="affilation" />
                            </div>
                        </div>
                        ...
                        <div className="row mb-5">
                            <div className="col-md-4">
                                ...
                                <textarea className="form-control" onChange={(e) => userInformationOnchangeHandler(e)} value={userInformation.address} disabled = {isDisabled} id="address"></textarea>
                            </div>
                            ...
                            <div className="col-md-4">
                                <div className="row">
                                    <div className="col-md-12 mb-4">
                                        ...
                                        <input type="text" className="form-control" onChange={(e) => userInformationOnchangeHandler(e)} value={userInformation.pinCode} disabled = {isDisabled} id="pinCode" />
                                    </div>
                                    <div className="col-md-12">
                                        <label for="InputPhone" className="form-label">Phone</label>
                                        <input type="text" id="phoneNumber" disabled = {isDisabled} value={userInformation.phoneNumber} onChange={(e) => userInformationOnchangeHandler(e)} className="form-control" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4">
                                <div className="row">
                                    <div className="col-md-12 mb-4">
                                        ...
                                        <select className="form-select" onChange={(e) => userInformationOnchangeHandler(e)} aria-label="Default select example" value={userInformation.country} disabled = {isDisabled} id="country">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <input type="email" id="email" disabled = {isDisabled} value={userInformation.email}  onChange={(e) => userInformationOnchangeHandler(e)} className="form-control" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row mb-5">
                            <div className="col-md-4">
                                <div className="row">
                                    <div className="col-md-12 mb-4">
                                        ...
                                        <select className="form-select" onChange={(e) => userInformationOnchangeHandler(e)} aria-label="Default select example" value={userInformation.conferenceMode} disabled = {isDisabled}  id="conferenceMode">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <select className="form-select" onChange={(e) => userInformationOnchangeHandler(e)} aria-label="Default select example" value={userInformation.registrationCategory} disabled = {isDisabled} id="registrationCategory">
                                            <option selected>Please Select</option>
                            ...
                            <div className="col-md-4">
                                <div className="row">
                                    <div className="col-md-12 mb-4">
                                        ...
                                        <select className="form-select" onChange={(e) => userInformationOnchangeHandler(e)} aria-label="Default select example" value={userInformation.participationType} disabled = {isDisabled} id="participationType">
                                            <option selected>Please Select</option>
                            ...
                            <div className="col-md-4">
                                ...
                                <textarea id="title" value={userInformation.title} disabled = {isDisabled} onChange={(e) => userInformationOnchangeHandler(e)} className="form-control"></textarea>
                            </div>
                        </div>
                            ...
                            <>
                                <div className="row mb-5">
                                    <div className="col-md-4">
                                        ...
                                        <input type="date" value={userInformation.arrivalDate} disabled = {isDisabled} id="arrivalDate" onChange={(e) => userInformationOnchangeHandler(e)} className="form-control" />
                                    </div>
                                    <div className="col-md-4">
                                        <label for="InputDeparture" className="form-label">Date of Departure</label>
                                        <input type="date" onChange={(e) => userInformationOnchangeHandler(e)} value={userInformation.departureDate} disabled = {isDisabled} id="departureDate" className="form-control" />
                                    </div>
                                    <div className="col-md-4">
                                        <label for="SelectJourney" className="form-label">Journey Mode</label>
                                        <select className="form-select" onChange={(e) => userInformationOnchangeHandler(e)} aria-label="Default select example" disabled = {isDisabled} value={userInformation.journeyMode} id="journeyMode">
                                            <option selected>Please Select</option>
                                ...
                                <div className='row'>
                                    <div className="col-md-4">
                                        ...
                                        <input type="text" onChange={(e) => userInformationOnchangeHandler(e)} value={userInformation.accompanyingPerson} disabled = {isDisabled} id="accompanyingPerson" className="form-control" />
                                    </div>
                                    <div className="col-md-4">
                                        <label for="SelectAccomodation" className="form-label">Accomodation details</label>
                                        <select className="form-select" onChange={(e) => userInformationOnchangeHandler(e)} aria-label="Default select example" value={userInformation.accomodationCategory} disabled = {isDisabled}  id="accomodationCategory" >
                                            <option selected>Please Select</option>
                        ...
                        <div className="row mb-5 d-none">
                            <div className="col-md-4">
                                <label for="SelectCategory" className="form-label">Registration Category</label>
                                <select className="form-select"  disabled = {isDisabled} onChange={(e) => userInformationOnchangeHandler(e)} aria-label="Default select example" value={userInformation.registrationCategory}    id="registrationCategory">
                            ...
                            <div className="col-md-4">
                                <label for="InputFee" className="form-label">Registration Fee</label>
                                <input type="text" onChange={(e) => userInformationOnchangeHandler(e)} disabled = {isDisabled} id="registrationFee" className="form-control" />
                            </div>
                            {/* <div className="col-md-4">
