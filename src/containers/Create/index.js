...
const CreateForm = (props) => {
  ...
  let generateQr = () => {
    qrInfo = userInformation.name + " " + userInformation.email + " " + userInformation.participationType + " " + value
    setQrInfo(qrInfo)
  }
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-md-12 text-end">
                ...
                <button type="button" onClick={() => generateQr()}>Save & Pay</button>
              </div>
            </div>
           { qrInfo && <QRCodeSVG value={qrInfo} /> }
          </div>
        </form>
      </div>
    </div>
