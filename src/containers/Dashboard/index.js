                                ...
                                <form className="d-flex">
                                    <div className="nav-item dropdown">
                                        <a className="text-decoration-none dropdown-toggle p-0 d-user-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            ...
                                            <span className='user-text me-2'>{loggedInUser.userEmail}</span>
                                        </a>
                                        <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li><a className="dropdown-item" href="#">Action</a></li>
                                            <li><a className="dropdown-item" href="#">Another action</a></li>
                                            
                                            <li>< button onClick={() => logoutUser()} className="dropdown-item" to="/">LogOut</button></li>
                                        </ul>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div className='col-md-3 left-part col-lg-2 px-0'>
                                <aside>
                                    <ul className='ps-0 list-unstyled mt-4'>
                                        ...
                                        { loggedInUser.role == "admin" && <li onClick={()=>navigate("/dashboard/test")} ><button className='common-blue btn'
                                        >View</button></li>}
                                    </ul>
