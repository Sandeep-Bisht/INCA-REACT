            ...
            <section className="section-padding contact-single1 about-single1">
                <div className="container">
                    <div className="row pb-4 align-items-center">
                        ...
                        <div className="col-md-6">
                            <p className="common-para">Magnam corporis rem commodi dolore possimus varius justo litora ipsum
                        ...
                        <div className="col-md-4">
                            <div className="boxes">
                                <div className="box-1">
                                    ...
                                    <p className="common-para">Habitant porta viverra voluptatum facilisi. Dolor mi sit! Recusandae,
                                        nisl, habitasse justo architecto viverra volupt.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6">
                            ...
                            <p className="common-para">Consequat sociosqu sem officiis aute ridiculus repellat in aliquip at, metus
                                sociosqu veritatis
                                cubilia ac soluta? Faucibus ipsam, incidunt cras.</p>

                            <div class="aim">
                                <h3 class="h2">LEARN FROM THE BEST IN INDUSTRY</h3>
                                <p class="common-para">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis
                                    impedit doloribus dolorum nemo nesciunt magni aperiam perspiciatis placeat maxime quo!</p>
                            </div>
